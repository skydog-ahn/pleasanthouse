...
const i18nData = {
  ko: {
    ...
    hero_title: "천년의 숨결을 품은 아스카 들판,<br><span class=\"text-gold\">단 한 팀만을 위한</span> 따뜻한 쉼의 집",
    hero_desc: "전 세계 여행자 누구에게나 열린 프라이빗 고민가 독채 스테이.<br>매일 아침 갓 구운 천연효모 빵 조식과 전일정 힐링 E-Bike 투어로 아스카의 평화로운 낭만을 편안하게 즐겨보세요.",
    feat1_title: "프라이빗 고민가 독채",
    feat1_sub: "1일 1팀 전용 힐링",
    ...
    story_title: "마음을 잇는 여유, 모두를 위한 쉼터",
    story_lead: "Pleasant House는 단순한 숙박 시설이 아닙니다. 천년 역사를 품은 야외 박물관 아스카무라에서, 국적과 언어를 넘어 전 세계 누구나 내 집처럼 편안하고 즐거운 여행을 누리실 수 있도록 정성을 다해 빚어낸 프라이빗 힐링 안식처입니다.",
    story_c1_title: "삶의 여유와 환대를 최우선으로",
    story_c1_desc: "이윤을 좇기보다 방문객 한 분 한 분과의 진솔한 교감을 지향합니다. 하루 단 1팀에게만 온전한 공간과 진심 어린 시간을 전합니다.",
    ...
    story_c3_title: "전 세계 여행자를 위한 다국어 환대",
    story_c3_desc: "한국어, 일본어, 영어 3개국어로 소통하며, 언어의 장벽 없이 전 세계 누구나 편안하게 머무르실 수 있도록 세심한 로컬 안내와 따뜻한 맞춤형 환대를 제공합니다.",
    host_quote_text: "바쁜 일상에서 벗어나 소중한 사람과 눈을 맞추고, 갓 구운 빵 냄새와 함께 아침을 맞이하며, 바람결 따라 자전거를 달리는 자유. 저희가 아스카에서 찾은 이 평화로운 행복을 전 세계 모든 여행자와 나누고 싶습니다.",
    host_name: "Pleasant House 호스트 올림",
    host_role: "Pleasant House 호스트 & 가이드",
    pillars_kicker: "FOUR SYNERGIES",
    pillars_title: "Pleasant House를 이루는 4가지 감동",
    pillars_lead: "숙박, 수제 베이커리, E-Bike 가이드 투어, 그리고 북카페 라운지의 결합 — 여행의 모든 순간이 하나의 아름다운 이야기로 이어집니다.",
    p1_badge: "PILLAR 01 · 宿泊",
    p1_heading: "고풍스러운 전통 고민가의 온전한 사유",
    p1_desc: "나라 전통 가옥의 웅장한 목조 대들보와 다다미의 포근함, 현대적 럭셔리 설비가 조화를 이룹니다. 다른 투숙객 없이 정원과 툇마루(엔가와), 히노끼 감성의 욕조까지 오직 귀하만을 위해 준비됩니다.",
    ...
    p4_badge: "PILLAR 04 · 북카페 라운지 & 스냅 촬영",
    p4_heading: "대화와 음악이 흐르는 북카페 라운지, 그리고 시네마틱 스냅",
    p4_desc: "오래된 고재 서가와 LP 턴테이블이 놓인 북카페 라운지에서 현지 로컬 차와 담소를 나눕니다. 투어와 숙박 중에는 호스트가 전문 장비로 두 분의 자연스러운 미소와 아스카의 절경을 담은 고화질 스냅 사진과 숏폼 비디오를 선물해 드립니다.",
    p4_pt1: "✓ 여행 중 촬영된 원본 및 보정본 사진 30장+ 증정",
    p4_pt2: "✓ 저녁 시간 라운지에서 즐기는 따뜻한 차와 교류의 시간",
    p4_pt3: "✓ 결혼기념일, 생일, 프로포즈를 위한 서프라이즈 지원",
    stay_kicker: "ROOM & AMENITIES",
    stay_title: "온전한 사색과 휴식을 위한 프라이빗 공간",
    stay_lead: "역사 깊은 일본 전통 목조 가옥의 고즈넉한 정취를 살리면서, 현대적 라이프스타일에 맞게 품격 있게 리노베이션하였습니다.",
    spec1_t: "독채 공간 구성",
    spec1_d: "넓은 거실과 침실, 전통 다실, 다이닝 키친, 전용 사계절 정원",
    spec2_t: "침실 구성",
    ...
    rain_policy_d: "기상 악화로 자전거 운행이 어려운 날에는 당황하실 필요가 없습니다. Pleasant House 실내에서 즐기는 '천연효모 수제 베이킹 클래스', '아스카 역사 문화 스토리텔링', 또는 차량을 이용한 '에도 전통거리(이마이초) 산책 투어'로 안전하게 대체 진행됩니다.",
    ...
    p1_f1: "✓ 프라이빗 전통 고민가 독채 1박 (1일 1팀 전용)",
    ...
    p1_f7: "✓ 우천 시 수제 베이킹 클래스 & 역사 스토리텔링 무료 대체",
    ...
    p2_f1: "✓ 프라이빗 전통 고민가 독채 1박 (1일 1팀 전용)",
    p2_f2: "✓ 당일 아침 갓 구운 천연효모 수제 베이커리 & 로컬 조식",
    p2_f3: "✓ 웰컴 로컬 티 & 계절 디저트 제공",
    p2_f4: "✓ 라이브러리 서가 및 음악 감상 라운지 자유 이용",
    ...
    faq_a1: "네, 맞습니다. Pleasant House는 오직 하루 단 한 팀(기본 2인, 최대 4인)에게만 가옥 전체와 전용 정원을 온전히 제공합니다. 다른 여행자의 방해 없이 완벽한 프라이버시와 평온함을 누리실 수 있습니다.",
    faq_q2: "Q. 일본어를 잘 못해도 여행과 소통에 문제가 없나요?",
    faq_a2: "전혀 걱정하지 않으셔도 됩니다. Pleasant House는 한국어, 일본어, 영어 3개국어 완벽 응대가 가능하여 전 세계 누구나 언어의 장벽 없이 편안한 여행을 즐기실 수 있습니다. 예약 상담부터 투어 가이드, 긴급 상황 대처까지 모국어처럼 친절하게 안내해 드립니다.",
    ...
    faq_a4: "우천 시에는 참가자의 안전을 위해 야외 자전거 투어를 중단하고, Pleasant House 실내에서 진행되는 '천연효모 제빵 클래스', '아스카 역사 문화 스토리텔링', 또는 차량을 이용한 '에도 전통거리(이마이초) 산책 투어'로 무료 전환됩니다. 비가 와도 더욱 낭만적인 추억을 만드실 수 있습니다.",
    ...
    foot_desc: "나라현 아스카무라의 아름다운 자연과 고대 역사 속에서 삶의 쉼표를 선물하는 1일 1팀 한정 체험형 고민가 프라이빗 게스트하우스.",
    foot_quick: "빠른 이동",
  ...
  ja: {
    ...
    hero_title: "千年の息吹を宿す明日香、<br><span class=\"text-gold\">一日一組だけの</span> 温もりあふれる宿",
    hero_desc: "世界中の旅人を温かく迎える、一日一組限定の古民家ステイ。<br>焼きたてパン朝食とE-Bikeツアーで、明日香の豊かな自然と歴史をご満喫ください。",
    feat1_title: "プライベート古民家一棟貸し",
    feat1_sub: "1日1組限定の贅沢",
    feat2_title: "手作りパンの朝食",
    feat2_sub: "焼きたて天然酵母パン",
    feat3_title: "E-Bikeガイドツアー",
    feat3_sub: "文化財を専属案内",
    feat4_title: "記念スナップ写真贈呈",
    feat4_sub: "旅の思い出を高画質記録",
    ...
    story_kicker: "PHILOSOPHY & STORY",
    story_title: "心をつなぐやすらぎ、世界中の旅人のための家",
    story_lead: "Pleasant House（プレザントハウス）は、単なる宿泊施設ではありません。国境や言葉の壁を越え、世界中の旅人がまるで我が家のように心地よく寛ぎ、豊かな人生の余白を味わっていただけるよう創り上げた体験型リトリートです。",
    ...
    story_c3_title: "世界中の旅人に寄り添う多言語対応",
    story_c3_desc: "日本語・韓国語・英語でのスムーズなコミュニケーションに対応。言葉の不安なく、世界中どなたでも安心して心地よい滞在を満喫していただけます。",
    host_quote_text: "忙しい日常を少し離れて、大切な人と語らい、焼きたてパンの香りで目覚め、風を感じて自転車を走らせる。私たちが明日香で見つけた豊かな幸せを、ぜひご体験ください。",
    host_name: "Pleasant House ホストより",
    host_role: "Pleasant House ホスト＆専属ガイド",
    pillars_kicker: "FOUR SYNERGIES",
    pillars_title: "Pleasant Houseが誇る4つの体験",
    pillars_lead: "宿泊、焼き立てパン朝食、E-Bikeツアー、そしてブックカフェラウンジ。すべてが重なり合い、一生の記憶に残る滞在を紡ぎます。",
    p1_badge: "PILLAR 01 · 宿泊",
    p1_heading: "趣ある伝統古民家を、<br>贅沢に独り占め",
    ...
    p2_badge: "PILLAR 02 · 朝食・製パン",
    p2_heading: "朝の目覚めを彩る天然酵母パン、<br>そして明日香野菜の朝食",
    ...
    p3_badge: "PILLAR 03 · 自転車ツアー",
    p3_heading: "古代の風を駆け抜ける、<br>プライベートE-Bikeツアー",
    ...
    p4_badge: "PILLAR 04 · 북카페 라운지 & 스냅 촬영",
    p4_heading: "音楽と語らいのカフェラウンジ、<br>記念スナップ撮影",
    p4_desc: "古材の本棚とレコードが流れるラウンジで、香り高いお茶とともにゆったりとした夜を。ツアー中にはホストがプロ機材で自然なお二人の笑顔と明日香の絶景を高画質スナップで撮影しプレゼントします。",
    p4_pt1: "✓ 高画質スナップ写真（30カット以上データ贈呈）",
    p4_pt2: "✓ 夜のラウンジで楽しむ特別なお茶とおもてなし",
    p4_pt3: "✓ 記念日・誕生日・プロポーズのサプライズ対応",
    stay_kicker: "ROOM & AMENITIES",
    stay_title: "お二人だけの静謐なプライベート空間",
    stay_lead: "歴史ある日本家屋の風情を残しながら、快適な現代仕様へと贅沢にリノベーションいたしました。",
    spec1_t: "専有空間の構成",
    spec1_d: "広々としたリビング、主寝室、和室茶室、ダイニングキッチン、専用日本庭園",
    spec2_t: "ベッド構成",
    ...
    rain_policy_d: "天候不良で自転車運行が難しい場合でもご安心ください。館内での「自家製パン作り体験」「明日香歴史ストーリーテリング」、またはお車での「重要伝統的建造物群保存地区・今井町巡り」へ振替可能です。",
    price_kicker: "TRANSPARENT VALUE",
    ...
    p1_f1: "✓ プライベート古民家一棟貸し 1泊（一日一組限定）",
    p1_f2: "✓ 当日早朝に焼き上げる天然酵母パン＆旬の明日香野菜朝食",
    p1_f3: "✓ ホスト専任 E-Bikeガイドツアー（装備一式付）",
    p1_f4: "✓ 高画質記念スナップ写真＆動画データ贈呈",
    p1_f5: "✓ レクリエーション傷害保険・賠償責任保険加入",
    p1_f6: "✓ 近鉄飛鳥駅 無料往復送迎",
    p1_f7: "✓ 雨天時パン教室または歴史体験への安心無料振替",
    ...
    faq_a1: "はい、ございません。伝統ある古民家と専用日本庭園を、一日一組様（基本2名、最大4名）だけで貸切にてご利用いただけます。",
    faq_q2: "Q. 外国語対応や言葉の不安はありますか？",
    faq_a2: "ご安心ください。当宿では日本語・韓国語・英語の3カ国語で完全対応しており、世界中の旅人が言葉の壁を感じることなく快適にお過ごしいただけます。",
    ...
    faq_a4: "雨天時は安全を考慮し、館内での「手作りパン教室」「明日香歴史ストーリーテリング」、またはお車での「今井町伝統街並みツアー」へと無料で変更いたします。",
    ...
    foot_desc: "奈良県明日香村の豊かな自然と歴史に抱かれた、1日1組限定の体験型古民家プライベートゲストハウス「Pleasant House（プレザントハウス）」。",
    foot_quick: "クイックリンク",
    foot_info: "施設・運営情報"
  },
  en: {
    ...
    hero_desc: "A warm private Kominka estate welcoming travelers from all over the world.<br>Freshly baked artisanal bread every morning, scenic guided E-Bike heritage tours, and authentic heartfelt hospitality in ancient Asuka.",
    feat1_title: "Private Kominka Estate",
    ...
    story_kicker: "PHILOSOPHY & STORY",
    story_title: "A Peaceful Sanctuary Welcoming Global Travelers",
    story_lead: "Pleasant House is more than just lodging. Set in the ancient historic sanctuary of Asuka, it is an exclusive private estate where global travelers of all backgrounds can experience peaceful comfort, slow living, and heartfelt care.",
    ...
    story_c3_title: "Multilingual Global Hospitality",
    story_c3_desc: "Fluent in English, Japanese, and Korean, we ensure effortless communication and personalized local care so every guest feels completely at home.",
    host_quote_text: "To wake up to the scent of warm oven-fresh bread, share meaningful conversations in our library lounge, and cycle alongside ancient hills — we warmly invite you to experience this gentle joy in Asuka.",
    host_name: "From the Pleasant House Hosts",
    host_role: "Hosts & Local Heritage Guides",
    pillars_kicker: "FOUR SYNERGIES",
    pillars_title: "The Four Synergy Pillars of Pleasant House",
    pillars_lead: "Private accommodation, artisanal baking, guided cycling tours, and an intimate cafe lounge seamlessly intertwine to create your perfect getaway.",
    p1_badge: "PILLAR 01 · STAY",
    p1_heading: "Exclusive Traditional Japanese Kominka Residence",
    ...
    p4_badge: "PILLAR 04 · CAFE LOUNGE & SNAPS",
    p4_heading: "Music, Book Cafe Lounge & Commemorative Photography",
    ...
    p4_pt2: "✓ Relaxed evening tea & cultural conversation in the lounge",
    ...
    stay_lead: "A meticulously renovated Japanese heritage residence balancing wabi-sabi serenity and modern luxury.",
    spec1_t: "Private Floor Area",
    spec1_d: "Spacious living room, master bedroom, tea room, dining kitchen, and private Zen garden",
    ...
    rain_policy_d: "If weather prevents cycling, our indoor programs seamlessly kick in: artisan sourdough bread making, Asuka history storytelling, or a private driven excursion to the historic Edo merchant district of Imai-cho.",
    price_kicker: "TRANSPARENT VALUE",
    ...
    p1_f1: "✓ 1 Night Private Kominka Estate (1 group per day)",
    ...
    p2_f1: "✓ 1 Night Private Kominka Estate (1 group per day)",
    p2_f2: "✓ Oven-fresh artisanal sourdough & local Asuka breakfast spread",
    p2_f3: "✓ Welcome local tea & seasonal sweet treats",
    p2_f4: "✓ Unlimited access to Library lounge, vinyl listening area & garden",
    ...
    faq_a1: "Yes, absolutely! Pleasant House is strictly reserved for one group (2 to 4 guests) per day. You enjoy the entire heritage home and Japanese garden in total privacy.",
    faq_q2: "Q. Can we communicate in English or Korean?",
    faq_a2: "Yes! We provide full multilingual support in English, Japanese, and Korean. Travelers from anywhere in the world can enjoy a seamless, stress-free stay with personalized care from booking to departure.",
    ...
    faq_a4: "For your safety, outdoor cycling is paused and seamlessly replaced with our indoor Artisan Sourdough Baking Class, Asuka History Storytelling, or an automobile excursion to historic Imai-cho.",
