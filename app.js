...
const i18nData = {
  ...
  ja: {
    ...
    hero_desc: "世界中の旅人を温かく迎える、一日一組限定のプライベート古民家ステイ。<br>焼き立ての天然酵母パン朝食と爽快なE-Bikeガイドツアーで、明日香村の豊かな自然と歴史を心ゆくまでお楽しみください。",
    ...
    p4_badge: "PILLAR 04 · 북카페 라운지 & 스냅 촬영",
    p4_heading: "音楽と語らいのブックカフェラウンジ、そして記念スナップ撮影",
    ...
    p1_f6: "✓ 近鉄飛鳥駅 無料往復送迎",
    p1_f7: "✓ 雨天時パン教室または歴史ストーリーテリングへの安心無料振替",
